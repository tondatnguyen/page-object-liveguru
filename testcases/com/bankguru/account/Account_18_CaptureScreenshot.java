...
import configReportHTML.ExtentTestManager;

public class Account_18_CaptureScreenshot extends AbstractTest {
	...
	@Test
	public void TC_01_ValidateNewCustomerForm(Method method) throws Exception {
		ExtentTestManager.startTest(method.getName(), "TC_01_ValidateNewCustomerForm");
		...
		verifyEquals(newCustomerPage.getErrorMessageOfDynamicField(driver, "PIN"), "PIN Code must not be blankkkkkkkkkkkkkk");
		Thread.sleep(3000);
