...
public class LoginPageUI {
	...
	public static final String DELETE_CUSTOMER_FORM_AT_LOGIN_PAGE = "//ul[@class='dropdown-menu']//a[text()='Delete Customer Form']";
	public static final String SELENIUM_DROPDOWN_TOOGLE_AT_LOGIN_PAGE = "//a[@class='dropdown-toggle' and contains(text(),'Selenium')]";
